...
import com.ttrp.manager.service.implementation.JwtService;
import com.ttrp.manager.service.implementation.SessionService;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if(tokenCredentials.isPresent()
            ...
            Optional<UserIdentity> userDetails = this.sessionService.validateSessionViaJwtAndGetUser(
                    tokenCredentials.get().refreshTokenId(),
                    tokenCredentials.get().userEmail());

            if(userDetails.isPresent()){
                UserIdentity user = userDetails.get();
